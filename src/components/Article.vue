<template>
	<div id="article">
		...
		<div class="content">                  <!--绑定属性需要加上:获取数据时不需要加上{{}}-->
			<div class="header clear"><h2><img :src="articleData.author_face" alt=""/></h2><p>智能社</p></div>
		    <div class="cont">
		    	<h3>{{articleData.title}}</h3>
		        <div class="time"><p>{{articleData.time | normalTime}} <span><img src="../../static/assets/img/zan.png" alt=""/></span></p></div>
		...
		<div class="foot-btn">
			<ul>
		    	...
		    	<li class="xing"><a href="javascript:;">
		        	<i><img src="../../static/assets/img/xing.png" alt=""/></i>
		        </a></li>
		    	<li class="fx"><a href="javascript:;">
		        	<i><img src="../../static/assets/img/fx.png" alt=""/></i>
		        </a></li>
		    </ul>
		</div>
	</div>
...
<style scoped>
		...
		.nav ul li{width:0.29rem;height:0.31rem; background:url(../../static/assets/img/history.png) no-repeat 0 0; background-size:100%; margin:0 0 0 0.38rem;}
		...
		.text-box p{ line-height:0.45rem !important; margin-bottom:0.1rem;}
		...
		.say i{width:0.36rem;height:0.26rem; background:url(../../static/assets/img/say.png) no-repeat 0 0; background-size:100%; float:left; margin-left:0.7rem; margin-top:0.13rem;}
		...
		.zan i{width:0.36rem;height:0.28rem; background:url(../../static/assets/img/zan1.png) no-repeat 0 0; background-size:100%; float:left; margin-left:0.54rem; margin-top:0.13rem;}
